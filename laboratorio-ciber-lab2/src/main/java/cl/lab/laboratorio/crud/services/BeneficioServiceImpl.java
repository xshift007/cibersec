...
public class BeneficioServiceImpl implements BeneficioService {
    ...
    public void crearBeneficio(BeneficioModel model) {
        if (beneficioRepository.existsByCodigo(BigDecimal.valueOf(model.getCodigo()))) {
            throw new CrudException("Beneficio con el mismo código ya existe.");
        }

        if (beneficioRepository.existsByNombre(model.getNombre())) {
            throw new CrudException("Ya existe un beneficio con ese nombre.");
        }
